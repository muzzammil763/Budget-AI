  ...
  src/
    ...
    finances/
      finances_screen.dart      List (month/overall pills, responsive search +
                                manual-add button, income/expense totals card); tap → edit
