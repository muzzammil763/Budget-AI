  ...
  src/
    ...
    finances/
      finances_screen.dart      List (month/overall pills, responsive search +
                                manual-add button, expense-total card); tap → edit
