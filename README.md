...
- Chat responses use low reasoning effort, low text verbosity, and explicit `top_p: 1.0` sampling by default, while preserving important amounts, dates, caveats, and next actions.
